...
export default function AddStaff() {
  ...
  const imageUrl =
    "https://i.pinimg.com/564x/bc/d4/d8/bcd4d8028a16a6b4e3e0ecbcfd2ca437.jpg";
      ...
      >
        ...
        <View>
          ...
          {Platform.OS === "web" ? (
            ...
            >
              <Text
                style={{ fontSize: 17, color: birthDate ? "black" : "gray" }}
              >
          ...
          {/* <TextInput
            value={workingDays}
            onChangeText={(workingDays) => setWorkingDays(workingDays)}
            placeholderTextColor="gray"
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => console.log("Gender Picker Opened")}
            >
