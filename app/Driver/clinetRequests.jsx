...
const RequestItem = ({
  ...
  const handleMarkAsDone = async () => {
    try {
      ...
      Alert.alert("Success", "Request marked as done and deleted.");
      router.push("../(tab)/driver"); // Redirect to home screen
    } catch (error) {
  ...
  return (
    <View style={styles.paymentItem}>
      ...
      {approvement === "approved" && paymentStatus === "paid" && (
        <View style={styles.acceptView}>
          <TouchableOpacity style={styles.acceptButton}>
            <Text style={styles.acceptText}>Lets Start The Trip</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.acceptButton, styles.markAsDoneButton]}
            onPress={handleMarkAsDone}
          >
            <Text style={styles.acceptText}>Mark as Done</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
...
const styles = StyleSheet.create({
  ...
  markAsDoneButton: {
    backgroundColor: "red", // Constant red color for "Mark as Done" button
  },
});
